...
`;class cardContent{static generateTitle(e){const s=e.title!==void 0?oe` <h1 class="pool-monitor-title">${e.title}</h1> `:oe``;return oe`${s}`}static generateBody(e,s){if(!s)return oe` <div class="warning-message">No sensor data available</div> `;return oe`
    ...
    `}static _moreinfo(e){const s=new Event("hass-more-info",{bubbles:true,composed:true});s.detail={entityId:e};const o=document.querySelector("home-assistant");if(o)o.dispatchEvent(s)}}const Oe={compact:false,show_names:true,show_labels:true,show_last_updated:false,show_icons:true,show_units:true,gradient:true,language:"en"};const Pe={low:"#fdcb6e",warn:"#e17055",normal:"#00b894",cool:"#00BFFF",marker:"#000000",hi_low:"#00000099"};function getDisplayConfig(){return Object.assign({},Oe)}function getColorConfig(){return Object.assign({},Pe)}function getSensorConfig(e,s){if(!s[e])return{};return Object.assign({},s[e])}class MonitorCardBase extends i{render(){const e=this.getConfig();const s=this.processData();const o=e.display.compact?cardContent.generateCompactBody:cardContent.generateBody;if(!s||Object.keys(s).length===0)return oe` <div id="pool-monitor-card">
      ...
      ${Object.values(s).map(s=>{if(s===null||s===void 0?void 0:s.invalid)return oe`
          ...
          `;return o(e,s)})}
    </div>`}processData(){const e={};const s=this.getConfig();Object.entries(s.sensors).forEach(([s,o])=>{const r=Array.isArray(o)?o:[o];r.forEach((o,r)=>{var l,p,h;const u=`${s}_${r+1}`;e[u]=this.calculateData(s,o.title||this.getTranslatedText("sensor."+s),o.entity,o.min,o.max,o.setpoint,o.step,o.unit,o.icon,o.image_url,o.mode,o.min_limit,o.override_value,o.override,o.invalid,o.step_low,o.step_high,o.last_updated_entity,o.last_updated_attribute);if(o.availability_entity){const s=(h=(p=(l=this.hass)===null||l===void 0?void 0:l.states)===null||p===void 0?void 0:p[o.availability_entity])===null||h===void 0?void 0:h.state;e[u].disabled=s==="off"||s==="unavailable"}})});return e}getTranslatedText(e,s){var o;const r=((o=this.config)===null||o===void 0?void 0:o.display.language)||"en";const l=getTranslation(r,e);return formatTranslation(l,s)}calculateData(e,s,o,r,l,p,h,u,m,g,_,v,f,b,$,w,A,C,E){var O,P,T,j,F,U;const B={};const q=this.getConfig();const W=this.constructor.SENSORS||{};const G=getSensorConfig(e,W);const K=this.constructor.IMAGE_BASE_URL||"";B.name=e;B.invalid=$;B.mode=_;B.title=q.display.show_names?s:oe`&nbsp;`;B.hide_icon=false;B.is_mdi=false;if(!q.display.show_icons)B.hide_icon=true;else{const s=m||"";const o=g||"";if(s==="hide")B.hide_icon=true;else if(o)B.img_src=o;else if(s&&typeof s==="string"&&s.startsWith("mdi:")){B.is_mdi=true;B.mdi_icon=s}else if(K)B.img_src=`${K}/${e}.png`;else{B.is_mdi=true;B.mdi_icon="mdi:gauge"}}if(!this.hass||!this.hass.states||!this.hass.states[o]){console.warn(`Entity not found: ${o}`);B.value=null;B.entity=o;B.not_found=true;return B}const J=this.hass.states[o];const X=(O=this.hass.entities)===null||O===void 0?void 0:O[o];const Y=(U=(j=(P=X===null||X===void 0?void 0:X.display_precision)!==null&&P!==void 0?P:(T=J.attributes)===null||T===void 0?void 0:T.display_precision)!==null&&j!==void 0?j:(F=J.attributes)===null||F===void 0?void 0:F.precision)!==null&&U!==void 0?U:this.countDecimals(parseFloat(J.state));const Q=parseFloat(J.state);B.entity=o;if(isNaN(Q)){B.value=null;B.state="";B.color="var(--disabled-text-color, #bdbdbd)";B.pct="50";B.pct_min="50";B.pct_max="50";B.pct_cursor="50";B.pct_marker="50";B.pct_state_step="50";B.side_align="left";B.separator="";B.unit="";B.setpoint_class=["","","","",""];B.progressClass="";if(q.display.show_last_updated)B.last_updated=this.resolveLastUpdated(J,C,E);return B}B.value=Number(Q.toFixed(Y));if(q.display.show_last_updated)B.last_updated=this.resolveLastUpdated(J,C,E);B.unit=q.display.show_units?u||G.unit||"":"";if(b)B.value=f||G.override;B.min_value=r!==void 0&&this.hass.states[r]&&!isNaN(parseFloat(this.hass.states[r].state))?parseFloat(this.hass.states[r].state):B.value;B.max_value=l!==void 0&&this.hass.states[l]&&!isNaN(parseFloat(this.hass.states[l].state))?parseFloat(this.hass.states[l].state):B.value;const ee=p!=null?parseFloat(String(p)):G.setpoint!=null?parseFloat(String(G.setpoint)):B.value;const te=h!=null?parseFloat(String(h)):G.step!=null?parseFloat(String(G.step)):.1;const se=w!=null?parseFloat(String(w)):G.step_low!=null?parseFloat(String(G.step_low)):te;const ie=A!=null?parseFloat(String(A)):G.step_high!=null?parseFloat(String(G.step_high)):te;const re=Math.max(this.countDecimals(ee),this.countDecimals(se),this.countDecimals(ie));B.setpoint=ee;const ae=v!==void 0?Number(v):-1/0;const ne=Math.max(ae,ee-2*se);const le=Math.max(ae,ee-se);const de=Math.max(ae,ee);const ce=Math.max(ae,ee+ie);const pe=Math.max(ae,ee+2*ie);B.setpoint_class=[ne.toFixed(re),le.toFixed(re),de.toFixed(re),ce.toFixed(re),pe.toFixed(re)];B.separator=q.display.show_labels?"-":"";B.color="transparent";if(B.value!==null)B.value=Math.max(ae,B.value);if(_==="heatflow")if(Number(B.value)<Number(B.setpoint_class[1])){B.state=q.display.show_labels?this.getTranslatedText("state.1"):"";B.color=q.colors.cool}else if(Number(B.value)>=Number(B.setpoint_class[1])&&Number(B.value)<Number(B.setpoint_class[3])){B.state=q.display.show_labels?this.getTranslatedText("state.3"):"";B.color=q.colors.normal}else{B.state=q.display.show_labels?this.getTranslatedText("state.5"):"";B.color=q.colors.warn}else if(Number(B.value)<Number(B.setpoint_class[0])){B.state=q.display.show_labels?this.getTranslatedText("state.1"):"";B.color=q.colors.warn}else if(Number(B.value)>=Number(B.setpoint_class[0])&&Number(B.value)<Number(B.setpoint_class[1])){B.state=q.display.show_labels?this.getTranslatedText("state.2"):"";B.color=q.colors.low}else if(Number(B.value)>=Number(B.setpoint_class[1])&&Number(B.value)<Number(B.setpoint_class[2])){B.state=q.display.show_labels?this.getTranslatedText("state.3"):"";B.color=q.colors.normal}else if(Number(B.value)>=Number(B.setpoint_class[2])&&Number(B.value)<Number(B.setpoint_class[3])){B.state=q.display.show_labels?this.getTranslatedText("state.4"):"";B.color=q.colors.normal}else if(Number(B.value)>=Number(B.setpoint_class[3])&&Number(B.value)<Number(B.setpoint_class[4])){B.state=q.display.show_labels?this.getTranslatedText("state.5"):"";B.color=q.colors.low}else if(Number(B.value)>=Number(B.setpoint_class[4])){B.state=q.display.show_labels?this.getTranslatedText("state.6"):"";B.color=q.colors.warn}B.progressClass=e==="temperature"?"progress-temp":"progress";const he=ee-3*se;const ue=3*se+3*ie;B.pct=Math.max(0,Math.min(98.5,Math.max(0,B.value-he)/ue*.85*100+15)).toFixed(0);B.pct_min=Math.max(0,Math.min(98.5,Math.max(0,B.min_value-he)/ue*.85*100+15)).toFixed(0);B.pct_max=Math.max(0,Math.min(98.5,Math.max(0,B.max_value-he)/ue*.85*100+15)).toFixed(0);B.pct_marker=B.value>B.setpoint?B.pct-12:B.pct-5;B.side_align=B.value>ee?"right":"left";B.pct_cursor=B.value>ee?100-parseFloat(B.pct):parseFloat(B.pct)-2;B.pct_state_step=B.value>ee?105-parseFloat(B.pct):parseFloat(B.pct)+5;B.pct_min=B.value>ee?100-parseFloat(B.pct_min):parseFloat(B.pct_min)-2;B.pct_max=B.value>ee?100-parseFloat(B.pct_max):parseFloat(B.pct_max)-2;return B}countDecimals(e){if(e===void 0||e===null)return 0;if(Math.floor(e)===e)return 0;const s=e.toString();if(s.includes("."))return s.split(".")[1].length||0;return 0}resolveLastUpdated(e,s,o){var r,l,p;const h=s?(l=(r=this.hass)===null||r===void 0?void 0:r.states)===null||l===void 0?void 0:l[s]:e;if(!h)return this.timeFromNow(e.last_updated);if(o){const e=(p=h.attributes)===null||p===void 0?void 0:p[o];if(e)return this.timeFromNow(String(e))}return this.timeFromNow(h.last_updated)}timeFromNow(e){const s=new Date(e);const o=Date.now()-s.getTime();const t=(e,s)=>{const o=s===1?"time":"time_plural";const r={[e]:s};return this.getTranslatedText(`${o}.${e}`,r)};const r=Math.floor(o/6e4);const l=Math.floor(r/60);const p=Math.floor(l/24);if(r<1)return t("seconds",0);if(r<60)return t("minutes",r);if(l<24)return t("hours",l);return t("days",p)}getConfig(){return this.config}setConfig(e){const s=this.constructor.SENSORS||{};const o=Object.keys(s);const r={display:getDisplayConfig(),colors:getColorConfig()};const l=Object.assign(Object.assign({},e),{display:Object.assign(Object.assign({},r.display),e.display||{}),colors:Object.assign(Object.assign({},r.colors),e.colors||{}),sensors:{}});if(!e.sensors)throw new Error('Configuration requires sensors to be defined under the "sensors" key.');Object.entries(e.sensors).forEach(([e,r])=>{const p=s[e]||{};const h=Array.isArray(r)?[...r]:[Object.assign({},r)];if(h.length===0)throw new Error(`Empty sensor array for ${e}`);const u=h.map(e=>Object.assign(Object.assign(Object.assign({},p),e),{nameDefinedByUser:!!e.name}));u.forEach((s,r)=>{if(!s.entity)throw new Error(`Missing entity for ${e}[${r}]`);if(s.nameDefinedByUser)s.title=s.name;if(o.length>0&&!o.includes(e))s.invalid=true;else s.invalid=false});l.sensors[e]=u});this.config=l}}MonitorCardBase.SENSORS={};MonitorCardBase.IMAGE_BASE_URL="";MonitorCardBase.styles=Ee;__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"hass",void 0);__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"config",void 0);const Me="1.3.0";const Te="2026-02-24-09-56";const je=`${Me} (${Te})`;console.info(`%c SENSOR-MONITORING-CARD %c ${je} `,"color: white; background: #6c5ce7; font-weight: 700;","color: #6c5ce7; background: white; font-weight: 700;");window.customCards=window.customCards||[];window.customCards.push({type:"sensor-monitor-card",name:"Sensor Monitor Card",description:"Monitor any sensor with custom names, units, setpoints, and thresholds",preview:true,documentationURL:"https://github.com/wilsto/sensor-monitor-card"});e.SensorMonitorCard=class SensorMonitorCard extends MonitorCardBase{setConfig(e){super.setConfig(e)}static async getConfigElement(){await Promise.resolve().then(()=>Ue);return document.createElement("sensor-monitor-card-editor")}static getStubConfig(){return{sensors:{custom:{entity:""}}}}};e.SensorMonitorCard.CARD_INFO={cardType:"sensor-monitor-card",cardName:"Sensor Monitor Card",cardDescription:"A generic Home Assistant card for monitoring any sensor with customizable names, units, setpoints, and display options"};e.SensorMonitorCard.SENSORS={};e.SensorMonitorCard=__decorate([t$2("sensor-monitor-card")],e.SensorMonitorCard);function fireEvent(e,s,o){e.dispatchEvent(new CustomEvent(s,{bubbles:true,composed:true,detail:o}))}const Ne=[{name:"title",selector:{text:{}}}];const ze=[{name:"compact",selector:{boolean:{}}},{name:"show_names",selector:{boolean:{}}},{name:"show_labels",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"show_icons",selector:{boolean:{}}},{name:"show_units",selector:{boolean:{}}},{name:"gradient",selector:{boolean:{}}},{name:"language",selector:{select:{options:[{value:"en",label:"English"},{value:"fr",label:"Français"},{value:"de",label:"Deutsch"},{value:"es",label:"Español"},{value:"it",label:"Italiano"},{value:"pt",label:"Português"},{value:"nl",label:"Nederlands"},{value:"pl",label:"Polski"},{value:"sk",label:"Slovenčina"},{value:"pt-br",label:"Português (Brasil)"},{value:"zh-cn",label:"中文 (简体)"},{value:"zh-tw",label:"中文 (繁體)"}]}}}];const Fe=[{name:"low",label:"Low",selector:{text:{}}},{name:"warn",label:"Warn",selector:{text:{}}},{name:"normal",label:"Normal",selector:{text:{}}},{name:"cool",label:"Cool",selector:{text:{}}},{name:"marker",label:"Marker",selector:{text:{}}},{name:"hi_low",label:"Hi/Low",selector:{text:{}}}];const He=i$3`
  .card-config {
    display: flex;
...
`;class MonitorEditorBase extends i{setConfig(e){this._config=Object.assign(Object.assign({},e),{display:Object.assign(Object.assign({},Oe),e.display),colors:Object.assign(Object.assign({},Pe),e.colors),sensors:e.sensors||{}})}render(){if(!this.hass||!this._config)return oe``;return oe`
    ...
    `}_renderSensorType(e,s){if(Array.isArray(s))return oe`${s.map((o,r)=>this._renderSensorRow(e,o,r,s.length>1))}`;return this._renderSensorRow(e,s,0,false)}_renderSensorRow(e,s,o,r){const l=r?`${e}-${o}`:e;const p=this._expanded[l]||false;const h=this.registry[e];const u=(h===null||h===void 0?void 0:h.name)||e;const m=r?`${u} #${o+1}`:u;return oe`
