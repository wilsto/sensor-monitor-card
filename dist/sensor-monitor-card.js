...
`;class cardContent{static generateTitle(e){const s=e.title!==void 0?oe` <h1 class="pool-monitor-title">${e.title}</h1> `:oe``;return oe`${s}`}static generateStatusBadge(e){return oe`
    ...
    `}static generateBody(e,s){if(!s)return oe` <div class="warning-message">No sensor data available</div> `;const o=s.pct_marker;const r=o<=1?"translateX(0)":o>=99?"translateX(-100%)":"translateX(-50%)";return oe`
      <!-- ##### ${s.name} section ##### -->
      <div
      ...
      >
        ...
        ${s.last_updated?oe`<span style="font-size:0.85em;opacity:0.7;">${s.last_updated}</span>`:""}
      </div>
    ...
    `}static _moreinfo(e){const s=new Event("hass-more-info",{bubbles:true,composed:true});s.detail={entityId:e};const o=document.querySelector("home-assistant");if(o)o.dispatchEvent(s)}}const Oe={compact:false,show_names:true,show_labels:true,show_last_updated:false,show_icons:true,show_units:true,gradient:true,language:"en"};const Pe={low:"#fdcb6e",warn:"#e17055",normal:"#00b894",cool:"#00BFFF",marker:"#000000",hi_low:"#00000099"};function getDisplayConfig(){return Object.assign({},Oe)}function getColorConfig(){return Object.assign({},Pe)}function getSensorConfig(e,s){if(!s[e])return{};return Object.assign({},s[e])}class MonitorCardBase extends i{render(){const e=this.getConfig();const s=this.processData();const o=this.resolveStatus();const r=e.display.compact?cardContent.generateCompactBody:cardContent.generateBody;if(!s||Object.keys(s).length===0)return oe` <div id="pool-monitor-card">
      ...
      ${Object.values(s).map(s=>{if(s===null||s===void 0?void 0:s.invalid)return oe`
          ...
          `;return r(e,s)})}
    </div>`}getCardSize(){var e,s,o,r;if(!((e=this.config)===null||e===void 0?void 0:e.sensors))return 3;const l=Object.values(this.config.sensors).reduce((e,s)=>e+(Array.isArray(s)?s.length:1),0);const u=(o=(s=this.config)===null||s===void 0?void 0:s.display)===null||o===void 0?void 0:o.compact;const p=((r=this.config)===null||r===void 0?void 0:r.title)?1:0;return p+l*(u?2:3)}getGridOptions(){const e=this.getCardSize();return{rows:e,min_rows:Math.max(2,Math.ceil(e/2)),columns:12,min_columns:6}}processData(){const e={};const s=this.getConfig();Object.entries(s.sensors).forEach(([s,o])=>{const r=Array.isArray(o)?o:[o];r.forEach((o,r)=>{var l,u,p,h,m;const g=`${s}_${r+1}`;e[g]=this.calculateData(s,o.title||this.getTranslatedText("sensor."+s),o.entity,o.min,o.max,o.setpoint,o.step,o.unit,o.icon,o.image_url,o.mode,o.min_limit,o.override_value,o.override,o.invalid,o.step_low,o.step_high,o.last_updated_entity,o.last_updated_attribute,o.setpoint_entity,o.min_limit_entity);if(o.availability_entity){const s=(p=(u=(l=this.hass)===null||l===void 0?void 0:l.states)===null||u===void 0?void 0:u[o.availability_entity])===null||p===void 0?void 0:p.state;e[g].disabled=s==="off"||s==="unavailable"}if(o.battery_entity){const s=(m=(h=this.hass)===null||h===void 0?void 0:h.states)===null||m===void 0?void 0:m[o.battery_entity];if(!s||s.state==="unavailable"||s.state==="unknown"){e[g].battery_level=null;e[g].battery_icon="mdi:battery-unknown";e[g].battery_color="var(--disabled-text-color, #bdbdbd)"}else{const o=parseFloat(s.state);if(isNaN(o)){e[g].battery_level=null;e[g].battery_icon="mdi:battery-unknown";e[g].battery_color="var(--disabled-text-color, #bdbdbd)"}else{e[g].battery_level=o;e[g].battery_icon=o>50?"mdi:battery":o>=20?"mdi:battery-50":"mdi:battery-20";e[g].battery_color=o>50?"var(--state-sensor-battery-high-color, #4caf50)":o>=20?"var(--state-sensor-battery-medium-color, #ff9800)":"var(--state-sensor-battery-low-color, #f44336)"}}}})});return e}getTranslatedText(e,s){var o;const r=((o=this.config)===null||o===void 0?void 0:o.display.language)||"en";const l=getTranslation(r,e);return formatTranslation(l,s)}calculateData(e,s,o,r,l,u,p,h,m,g,_,v,f,b,$,w,A,C,E,O,P){var T,j,F,U,B,q;const W={};const G=this.getConfig();const K=this.constructor.SENSORS||{};const J=getSensorConfig(e,K);const X=this.constructor.IMAGE_BASE_URL||"";W.name=e;W.invalid=$;W.mode=_;W.title=G.display.show_names?s:oe`&nbsp;`;W.hide_icon=false;W.is_mdi=false;if(!G.display.show_icons)W.hide_icon=true;else{const s=m||"";const o=g||"";if(s==="hide")W.hide_icon=true;else if(o)W.img_src=o;else if(s&&typeof s==="string"&&s.startsWith("mdi:")){W.is_mdi=true;W.mdi_icon=s}else if(X)W.img_src=`${X}/${e}.png`;else{W.is_mdi=true;W.mdi_icon="mdi:gauge"}}if(!this.hass||!this.hass.states||!this.hass.states[o]){console.warn(`Entity not found: ${o}`);W.value=null;W.entity=o;W.not_found=true;return W}const Y=this.hass.states[o];const Q=(T=this.hass.entities)===null||T===void 0?void 0:T[o];const ee=(q=(U=(j=Q===null||Q===void 0?void 0:Q.display_precision)!==null&&j!==void 0?j:(F=Y.attributes)===null||F===void 0?void 0:F.display_precision)!==null&&U!==void 0?U:(B=Y.attributes)===null||B===void 0?void 0:B.precision)!==null&&q!==void 0?q:this.countDecimals(parseFloat(Y.state));const te=parseFloat(Y.state);W.entity=o;if(isNaN(te)){W.value=null;W.state="";W.color="var(--disabled-text-color, #bdbdbd)";W.pct="50";W.pct_min="50";W.pct_max="50";W.pct_cursor="50";W.pct_marker="50";W.pct_state_step="50";W.side_align="left";W.separator="";W.unit="";W.setpoint_class=["","","","",""];W.progressClass="";if(G.display.show_last_updated)W.last_updated=this.resolveLastUpdated(Y,C,E);return W}W.value=Number(te.toFixed(ee));if(G.display.show_last_updated)W.last_updated=this.resolveLastUpdated(Y,C,E);W.unit=G.display.show_units?h||J.unit||"":"";if(b)W.value=f||J.override;W.min_value=r!==void 0&&this.hass.states[r]&&!isNaN(parseFloat(this.hass.states[r].state))?parseFloat(this.hass.states[r].state):W.value;W.max_value=l!==void 0&&this.hass.states[l]&&!isNaN(parseFloat(this.hass.states[l].state))?parseFloat(this.hass.states[l].state):W.value;const se=this.resolveEntityNumber(O);const ie=se!=null?se:u!=null?parseFloat(String(u)):J.setpoint!=null?parseFloat(String(J.setpoint)):W.value;const ae=p!=null?parseFloat(String(p)):J.step!=null?parseFloat(String(J.step)):.1;const re=w!=null?parseFloat(String(w)):J.step_low!=null?parseFloat(String(J.step_low)):ae;const ne=A!=null?parseFloat(String(A)):J.step_high!=null?parseFloat(String(J.step_high)):ae;const le=Math.max(this.countDecimals(ie),this.countDecimals(re),this.countDecimals(ne));W.setpoint=ie;const ce=this.resolveEntityNumber(P);const de=ce!=null?ce:v!==void 0?Number(v):-1/0;const ue=Math.max(de,ie-2*re);const pe=Math.max(de,ie-re);const he=Math.max(de,ie);const me=Math.max(de,ie+ne);const ge=Math.max(de,ie+2*ne);W.setpoint_class=[ue.toFixed(le),pe.toFixed(le),he.toFixed(le),me.toFixed(le),ge.toFixed(le)];W.separator=G.display.show_labels?"-":"";W.color="transparent";if(W.value!==null)W.value=Math.max(de,W.value);if(_==="heatflow")if(Number(W.value)<Number(W.setpoint_class[1])){W.state=G.display.show_labels?this.getTranslatedText("state.1"):"";W.color=G.colors.cool}else if(Number(W.value)>=Number(W.setpoint_class[1])&&Number(W.value)<Number(W.setpoint_class[3])){W.state=G.display.show_labels?this.getTranslatedText("state.3"):"";W.color=G.colors.normal}else{W.state=G.display.show_labels?this.getTranslatedText("state.5"):"";W.color=G.colors.warn}else if(Number(W.value)<Number(W.setpoint_class[0])){W.state=G.display.show_labels?this.getTranslatedText("state.1"):"";W.color=G.colors.warn}else if(Number(W.value)>=Number(W.setpoint_class[0])&&Number(W.value)<Number(W.setpoint_class[1])){W.state=G.display.show_labels?this.getTranslatedText("state.2"):"";W.color=G.colors.low}else if(Number(W.value)>=Number(W.setpoint_class[1])&&Number(W.value)<Number(W.setpoint_class[2])){W.state=G.display.show_labels?this.getTranslatedText("state.3"):"";W.color=G.colors.normal}else if(Number(W.value)>=Number(W.setpoint_class[2])&&Number(W.value)<Number(W.setpoint_class[3])){W.state=G.display.show_labels?this.getTranslatedText("state.4"):"";W.color=G.colors.normal}else if(Number(W.value)>=Number(W.setpoint_class[3])&&Number(W.value)<Number(W.setpoint_class[4])){W.state=G.display.show_labels?this.getTranslatedText("state.5"):"";W.color=G.colors.low}else if(Number(W.value)>=Number(W.setpoint_class[4])){W.state=G.display.show_labels?this.getTranslatedText("state.6"):"";W.color=G.colors.warn}W.progressClass=e==="temperature"?"progress-temp":"progress";const _e=ie-3*re;const ve=3*re+3*ne;const clamp01=e=>Math.max(0,Math.min(1,e));const toRatio=e=>ve>0?clamp01((e-_e)/ve):0;const fe=toRatio(W.value);W.pct=(fe*100).toFixed(1);W.pct_marker=fe*100;W.side_align=W.value>ie?"right":"left";W.pct_cursor=W.value>ie?100-fe*100:fe*100;W.pct_state_step=W.value>ie?100-fe*100+1:fe*100+1;const ye=toRatio(W.min_value)*100;const be=toRatio(W.max_value)*100;W.pct_min=W.value>ie?100-ye:ye;W.pct_max=W.value>ie?100-be:be;W.label_positions=[toRatio(ue)*100,toRatio(pe)*100,toRatio(he)*100,toRatio(me)*100,toRatio(ge)*100];return W}countDecimals(e){if(e===void 0||e===null)return 0;if(Math.floor(e)===e)return 0;const s=e.toString();if(s.includes("."))return s.split(".")[1].length||0;return 0}resolveStatus(){var e,s,o;const r=this.getConfig();const l=r.status_entity;if(!l)return null;const u=(s=(e=this.hass)===null||e===void 0?void 0:e.states)===null||s===void 0?void 0:s[l];if(!u)return null;const p=u.state;if(p==="unavailable"||p==="unknown")return null;const h=r.colors;const m=(o=u.attributes)===null||o===void 0?void 0:o.friendly_name;const g=parseFloat(p);let _;if(!isNaN(g))_=g<=33?"danger":g<=66?"warning":"good";else{const e=p.toLowerCase();const s=["safe","good","ok","healthy","optimal"];const o=["warning","caution","moderate"];const r=["danger","critical","bad","poor","unsafe"];if(s.includes(e))_="good";else if(o.includes(e))_="warning";else if(r.includes(e))_="danger";else _="unknown"}const v={good:h.normal,warning:h.low,danger:h.warn,unknown:"var(--disabled-text-color, #bdbdbd)"};const f={good:"mdi:check-circle",warning:"mdi:alert",danger:"mdi:alert-octagon",unknown:"mdi:help-circle"};return{label:p,color:v[_],icon:f[_],friendly_name:m,entity_id:l}}resolveEntityNumber(e){var s,o;if(!e)return null;const r=(o=(s=this.hass)===null||s===void 0?void 0:s.states)===null||o===void 0?void 0:o[e];if(!r)return null;const l=parseFloat(r.state);return isNaN(l)?null:l}resolveLastUpdated(e,s,o){var r,l,u;const p=s?(l=(r=this.hass)===null||r===void 0?void 0:r.states)===null||l===void 0?void 0:l[s]:e;if(!p)return this.timeFromNow(e.last_updated);if(o){const e=(u=p.attributes)===null||u===void 0?void 0:u[o];if(e)return this.timeFromNow(String(e))}return this.timeFromNow(p.last_updated)}timeFromNow(e){const s=new Date(e);const o=Date.now()-s.getTime();const t=(e,s)=>{const o=s===1?"time":"time_plural";const r={[e]:s};return this.getTranslatedText(`${o}.${e}`,r)};const r=Math.floor(o/6e4);const l=Math.floor(r/60);const u=Math.floor(l/24);if(r<1)return t("seconds",0);if(r<60)return t("minutes",r);if(l<24)return t("hours",l);return t("days",u)}getConfig(){return this.config}setConfig(e){const s=this.constructor.SENSORS||{};const o=Object.keys(s);const r={display:getDisplayConfig(),colors:getColorConfig()};const l=Object.assign(Object.assign({},e),{status_entity:e.status_entity,display:Object.assign(Object.assign({},r.display),e.display||{}),colors:Object.assign(Object.assign({},r.colors),e.colors||{}),sensors:{}});if(!e.sensors)throw new Error('Configuration requires sensors to be defined under the "sensors" key.');Object.entries(e.sensors).forEach(([e,r])=>{const u=s[e]||{};const p=Array.isArray(r)?[...r]:[Object.assign({},r)];if(p.length===0)throw new Error(`Empty sensor array for ${e}`);const h=p.map(e=>Object.assign(Object.assign(Object.assign({},u),e),{nameDefinedByUser:!!e.name}));h.forEach((s,r)=>{if(!s.entity)throw new Error(`Missing entity for ${e}[${r}]`);if(s.nameDefinedByUser)s.title=s.name;if(o.length>0&&!o.includes(e))s.invalid=true;else s.invalid=false});l.sensors[e]=h});this.config=l}}MonitorCardBase.SENSORS={};MonitorCardBase.IMAGE_BASE_URL="";MonitorCardBase.styles=Ee;__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"hass",void 0);__decorate([n$1({attribute:false})],MonitorCardBase.prototype,"config",void 0);const Me="1.8.1";const Te="2026-03-21-12-19";const je=`${Me} (${Te})`;console.info(`%c SENSOR-MONITORING-CARD %c ${je} `,"color: white; background: #6c5ce7; font-weight: 700;","color: #6c5ce7; background: white; font-weight: 700;");window.customCards=window.customCards||[];window.customCards.push({type:"sensor-monitor-card",name:"Sensor Monitor Card",description:"Monitor any sensor with custom names, units, setpoints, and thresholds",preview:true,documentationURL:"https://github.com/wilsto/sensor-monitor-card"});e.SensorMonitorCard=class SensorMonitorCard extends MonitorCardBase{setConfig(e){super.setConfig(e)}static async getConfigElement(){await Promise.resolve().then(()=>Ue);return document.createElement("sensor-monitor-card-editor")}static getStubConfig(){return{sensors:{custom:{entity:""}}}}};e.SensorMonitorCard.CARD_INFO={cardType:"sensor-monitor-card",cardName:"Sensor Monitor Card",cardDescription:"A generic Home Assistant card for monitoring any sensor with customizable names, units, setpoints, and display options"};e.SensorMonitorCard.SENSORS={};e.SensorMonitorCard=__decorate([t$2("sensor-monitor-card")],e.SensorMonitorCard);function fireEvent(e,s,o){e.dispatchEvent(new CustomEvent(s,{bubbles:true,composed:true,detail:o}))}const Ne=[{name:"title",selector:{text:{}}},{name:"status_entity",label:"Status entity",selector:{entity:{}}}];const ze=[{name:"compact",selector:{boolean:{}}},{name:"show_names",selector:{boolean:{}}},{name:"show_labels",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"show_icons",selector:{boolean:{}}},{name:"show_units",selector:{boolean:{}}},{name:"gradient",selector:{boolean:{}}},{name:"language",selector:{select:{options:[{value:"en",label:"English"},{value:"fr",label:"Français"},{value:"de",label:"Deutsch"},{value:"es",label:"Español"},{value:"it",label:"Italiano"},{value:"pt",label:"Português"},{value:"nl",label:"Nederlands"},{value:"pl",label:"Polski"},{value:"sk",label:"Slovenčina"},{value:"pt-br",label:"Português (Brasil)"},{value:"zh-cn",label:"中文 (简体)"},{value:"zh-tw",label:"中文 (繁體)"}]}}}];const He=[{name:"low",label:"Low",selector:{text:{}}},{name:"warn",label:"Warn",selector:{text:{}}},{name:"normal",label:"Normal",selector:{text:{}}},{name:"cool",label:"Cool",selector:{text:{}}},{name:"marker",label:"Marker",selector:{text:{}}},{name:"hi_low",label:"Hi/Low",selector:{text:{}}}];const Fe=i$3`
  .card-config {
    display: flex;
...
`;class MonitorEditorBase extends i{setConfig(e){this._config=Object.assign(Object.assign({},e),{display:Object.assign(Object.assign({},Oe),e.display),colors:Object.assign(Object.assign({},Pe),e.colors),sensors:e.sensors||{}})}render(){if(!this.hass||!this._config)return oe``;return oe`
    ...
    `}_renderSensorType(e,s){if(Array.isArray(s))return oe`${s.map((o,r)=>this._renderSensorRow(e,o,r,s.length>1))}`;return this._renderSensorRow(e,s,0,false)}_renderSensorRow(e,s,o,r){const l=r?`${e}-${o}`:e;const u=this._expanded[l]||false;const p=this.registry[e];const h=(p===null||p===void 0?void 0:p.name)||e;const m=r?`${h} #${o+1}`:h;return oe`
    ...
    `}_toggleExpand(e){this._expanded=Object.assign(Object.assign({},this._expanded),{[e]:!this._expanded[e]})}_addPresetSensor(e){const s=Object.assign(Object.assign({},this.sensors),{[e]:{entity:""}});this._expanded=Object.assign(Object.assign({},this._expanded),{[e]:true});this._fireSensorsChanged(s)}_addFreeformSensor(){const e=this._newSensorType.trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"");if(!e)return;if(this.sensors[e]){const s=this.sensors[e];const o=Array.isArray(s)?[...s]:[s];o.push({entity:""});const r=Object.assign(Object.assign({},this.sensors),{[e]:o});const l=`${e}-${o.length-1}`;this._expanded=Object.assign(Object.assign({},this._expanded),{[l]:true});this._fireSensorsChanged(r)}else{const s=Object.assign(Object.assign({},this.sensors),{[e]:{entity:""}});this._expanded=Object.assign(Object.assign({},this._expanded),{[e]:true});this._fireSensorsChanged(s)}this._newSensorType=""}_removeSensor(e,s){const o=this.sensors[e];if(Array.isArray(o)){const r=o.filter((e,o)=>o!==s);if(r.length===0){const s=this.sensors,o=e;s[o];const r=__rest(s,[typeof o==="symbol"?o:o+""]);this._fireSensorsChanged(r)}else if(r.length===1)this._fireSensorsChanged(Object.assign(Object.assign({},this.sensors),{[e]:r[0]}));else this._fireSensorsChanged(Object.assign(Object.assign({},this.sensors),{[e]:r}))}else{const s=this.sensors,o=e;s[o];const r=__rest(s,[typeof o==="symbol"?o:o+""]);this._fireSensorsChanged(r)}}_updateField(e,s,o,r){const l=this.sensors[e];if(Array.isArray(l)){const u=[...l];u[s]=Object.assign(Object.assign({},u[s]),{[o]:r});if(r===void 0||r==="")delete u[s][o];this._fireSensorsChanged(Object.assign(Object.assign({},this.sensors),{[e]:u}))}else{const s=Object.assign(Object.assign({},l),{[o]:r});if(r===void 0||r==="")delete s[o];this._fireSensorsChanged(Object.assign(Object.assign({},this.sensors),{[e]:s}))}}_fireSensorsChanged(e){this.dispatchEvent(new CustomEvent("sensors-changed",{bubbles:true,composed:true,detail:{sensors:e}}))}}MonitorSensorEditor.styles=Fe;__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"hass",void 0);__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"sensors",void 0);__decorate([n$1({attribute:false})],MonitorSensorEditor.prototype,"registry",void 0);__decorate([n$1({type:Boolean})],MonitorSensorEditor.prototype,"freeform",void 0);__decorate([r$1()],MonitorSensorEditor.prototype,"_expanded",void 0);__decorate([r$1()],MonitorSensorEditor.prototype,"_newSensorType",void 0);if(!customElements.get("monitor-sensor-editor"))customElements.define("monitor-sensor-editor",MonitorSensorEditor);let Re=class SensorMonitorCardEditor extends MonitorEditorBase{get sensorsRegistry(){return{}}get hasPresets(){return false}renderSensorSection(){return oe`
      ...
      ></monitor-sensor-editor>
    `}};Re=__decorate([t$2("sensor-monitor-card-editor")],Re);const Ue=Object.freeze(Object.defineProperty({__proto__:null,get SensorMonitorCardEditor(){return Re}},Symbol.toStringTag,{value:"Module"}));Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});return e}({});
